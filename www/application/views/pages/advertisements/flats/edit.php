...
<table style="width: 100%" id="redakt" border="1" bordercolor="#ccc" cellpadding="0" cellspacing="0">
    <tbody>
        ...
        <tr>
            <td colspan="2">
                <? if ($flat->loaded()) { ?>
                    <div class="senddata-token btn btn-primary" data-link="/advertisements_flats/edit/<?=$flat->id?>" data-input="#redakt">Применить изменения</div>
                <? } else { ?>
                    <div class="senddata-token btn btn-primary" data-link="/advertisements_flats/add" data-input="#redakt">Создать объявление</div>
                <? } ?>
            </td>
        </tr>
    </tbody>
