...
<div class="span6 options">
    ...
    <div id="redakt" class="newform">
        ...
        <fieldset>
            ...
            <div>
                <span>
                    <input name="email" data-validation="isemail;notempty" type="text" value="<?=$user->email?>" />
        ...
        <a class="btn btn-info btn-small" href="/posts/my">Изменить данные</a>
        <fieldset>
            <label>&nbsp;</label>
            <div>
        ...
        <fieldset>
            <label>Площадь:</label>
            <div class="setv">
                <input name="square" data-validation="isnumeric" type="text" value="<?=$advert->square?>"> м<sup>2</sup>
        ...
        <fieldset>
            ...
            <div class="setv">
                <input style="width: 100px;" name="price" data-validation="isnumeric;notempty" type="text" value="<?=$advert->price?>">
