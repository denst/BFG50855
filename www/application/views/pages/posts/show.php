...
<div class="span6 detail">
    ...
    <table>
        ...
        <tbody><tr class="tittle"><td colspan="2">Контактная информация</td></tr>
            ...
            <? if(Valid::not_empty($advert->cities_areas_id)):?>
            <tr>

                <td>Район:</td>

                <td><?=$advert->area->name?></td>
            ...
            <tr>
                ...
                <? if(isset($country)):?>
                    <td><?=Model_Price::convert_price($advert, $country)?></td>
                <? else:?>
                    <td><?=$advert->price?> <?=$advert->price_type->symbol?></td>
                <? endif?>
