...
<div id="content">
    <div class="loadcontent btn mt10px ml10px" data-link="/seoadmin/add">Создать</div>
        ...
        <table width="100%" border="1" align="center" bordercolor="#cccccc" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <tr>
                    ...
                    <td><?=$page->url?></td>
                    <td>
                        <img class="loadcontent" data-link="/seoadmin/edit/<?=$page->id?>" src="/themes/images/admin/edit.png" />
                        <img class="loadcontent" data-link="/seoadmin/delete/<?=$page->id?>" src="/themes/images/admin/delete.png" />
                    </td>
                </tr>
                <? } ?>
                <?=$pager?>
