...
<html xmlns="http://www.w3.org/1999/xhtmll" xml:lang="ru" lang="ru">
    <head>
        ...
        ?>
        <? if(isset($advert_title)):?>
            <title><?= $advert_title ?> | <?= APPLICATION_TITLE ?></title>
        <? else:?>
...
<div id="scrollToTop" title="в начало страницы" style="opacity: 1; display: none;" onclick="scroll(0,0)">
        <span class="upp">&nbsp;</span>
        <img src="/themes/images/up.gif" alt="в начало страницы" class="up" style="display: inline;">
</div>
        <div class="navbar navbar-fixed-bottom foot"><!-----          foot            ----->
            <div class="navbar-inner">
                <div class="container">
                    <span id="footer-text-container"><?= (isset($_seo_footer)) ? $_seo_footer: ''?></span>
